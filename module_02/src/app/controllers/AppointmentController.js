...
class AppointmentController {
    ...
    async store(req, res) {
        ...
        //verificando se provider_id é um provider
        ...
        const formattedDate = format(hourStart, "'dia' d 'de' MMMM, 'às' H:mm", { locale: pt });
    ...
    async delete(req, res) {
        ...
        await Mail.sendMail({
            ...
            context: {
                ...
                date: format(appointment.date, "'dia' d 'de' MMMM, 'às' H:mm", { locale: pt })
            }
        });
